...
public class Config {
  ...
  public Config setAlpha2(Float alpha2) {
    this.alpha2 = alpha2;
    return this;
  }
  ...
  public Config setTask(Float task) {
    this.task = task;
    return this;
  }
  ...
  public Integer getRestart() {
    if (restart == null) {
      throw new NullPointerException("Restart round is not set");
    }
    return restart;
  }
  ...
  public Float getTask() {
    if (task == null) {
      throw new NullPointerException("Task ID is not set");
    }
    return task;
  }
