...
public class CLI {
  ...
  @Option(name = "-restart", usage = "The round to restart temperature.")
  private int RESTART = 500;
  ...
  @Option(name = "-alpha2", usage = "Alpah parameter 2")
  private float ALPHA2 = 0.9f;
  ...
  @Option(name = "-task", usage = "Task ID in the assignment. Supported, 1, 2.1, 2.2, 3(Bonus)")
  private static float TASK = 1;
